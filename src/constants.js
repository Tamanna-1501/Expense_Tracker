export const EXPENSE_CATS = ['Food','Transport','Housing','Health','Shopping','Entertainment','Utilities','Education','Other']
export const INCOME_CATS  = ['Salary','Freelance','Investment','Gift','Bonus','Other']

export const CAT_ICONS = {
  Food:'🍔', Transport:'🚗', Housing:'🏠', Health:'💊',
  Shopping:'🛍️', Entertainment:'🎬', Utilities:'💡', Education:'📚',
  Other:'📦', Salary:'💼', Freelance:'💻', Investment:'📈',
  Gift:'🎁', Bonus:'🏆',
}

export const CAT_COLORS = {
  Food:'#FAECE7', Transport:'#E1F5EE', Housing:'#FAEEDA',
  Health:'#FBEAF0', Shopping:'#FAECE7', Entertainment:'#EAF3DE',
  Utilities:'#E6F1FB', Education:'#EEEDFE', Other:'#F1EFE8',
  Salary:'#E1F5EE', Freelance:'#E6F1FB', Investment:'#EAF3DE',
  Gift:'#FBEAF0', Bonus:'#FAEEDA',
}
